...
async def extract_vocabulary(text: str) -> List[dict]:
    """
    Extract ALL vocabulary from Farsi text using LLM with structured output.
    
    Args:
        text (str): The text to extract vocabulary from
        
    Returns:
        List[dict]: Complete list of vocabulary items in Farsi format with Persian script and transliteration
    """
