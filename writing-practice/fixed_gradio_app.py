...
def load_prompts():
    ...
    try:
        ...
        # Instead of raising an error, provide default prompts for Docker compatibility
        default_prompts = {
            "translation": {
                "system": "You are a precise Farsi to English translator. Your task is to provide a literal, word-for-word translation of Farsi text.",
                "user": "Translate the following Farsi text into English as literally as possible, keeping the exact meaning:\n\n{text}"
            },
            "grading": {
                "system": "You are a helpful Farsi language teacher who evaluates students' writing. Grade on a scale of S (excellent), A (good), B (acceptable), C (needs work), with detailed, constructive feedback.",
                "user": "Evaluate this student's handwritten Farsi translation.\n\nOriginal English: {target_sentence}\nStudent's Farsi: {submission}\nLiteral translation of student's Farsi: {translation}\n\nProvide a grade (S/A/B/C) and constructive feedback. Format your response as:\nGrade: [grade]\nFeedback: [detailed feedback]"
            }
        }
        logger.warning("Using default prompts as prompts.yaml was not found")
