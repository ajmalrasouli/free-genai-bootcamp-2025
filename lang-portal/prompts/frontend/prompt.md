...
We are building a Farsi langauge learning web-app which serves the following purposes:
- A portal to launch study activities
- to store, group and explor vocabulary
...
- Farsi: The Farsi word with Kanji
  - This will also contain a small button to play the sound of the word
  - The Farsi word will be a link to the Words Show page
